...
job-description-senior-engineer = Обучайте технических ассистентов
job-description-senior-researcher = Учите лаборантов изучению артефактов и взрывам РНД
job-description-senior-physician = Обучайте интернов хирургии и лечению
job-description-senior-officer = Учите кадетов есть пончики, стрелять и КЗ
